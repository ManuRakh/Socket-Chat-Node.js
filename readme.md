...
## Маршруты (New)
'/' - гетовый маршрут основной  страницы
'/admins/auth' - постовый маршрут авторизации админа
'/admin' - работает но временно не нужен вообще
'*' - показывает ошибку в случае если вы ошиблись вводом маршрута
